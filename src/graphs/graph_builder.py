...
class GraphBuilder:
    ...
    def build_language_graph(self):
        ...
        self.graph.add_node("bengali_translation",lambda state:self.blog_node_obj.translation({**state,"current_language":"bengali"}))
        ...
        self.graph.add_edge("bengali_translation",END)
        return self.graph
